...
def welcome():
     print(" [-] Welcome to RFID Authentication Key BruteForcer")
     print(" [-] This script aims to perform a brute-force attack on any NFC chip or a card.")
...
if args.file:
    ...
    welcome()
    print("[i] Performing pure brute-force on the tag.Generating all 274,941,996,890,625 combinations.")
